...
public class ASDR implements Parser {
    ...
    public boolean parse() {
        ...
        if(preanalisis.tipo == TipoToken.EOF && !hayErrores){
            System.out.println(ANSI_GREEN + "Codigo sintacticamente correcto" + ANSI_RESET);
            return  true;
        }else {
            return false;
        }
    ...
    private void STATEMENT(){ //STATEMENT -> EXPR_STMT | FOR_STMT | IF_STMT | PRINT_STMT | RETURN_STMT | WHILE_STMT | BLOCK
        ...
        if(isEXPR_STMTderiv()){
            ...
            hayErrores = true;
            System.out.println(ANSI_RED + "Error sintactico encontrado, se esperaba 'if', 'for', 'print', 'return', 'while', '{', '!', '-', 'true', 'false', 'null', un numero, una cadena, un identificador o '('" + ANSI_RESET);
            Main.error(1,"Error");
        }
    }
